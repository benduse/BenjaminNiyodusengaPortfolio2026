export const experience = [
  {
    ...
    summary:
      "Completed CodePath's intermediate web development track, culminating in TechHub, a full-featured developer resource-sharing forum built and deployed end-to-end.",
    highlights: ["React", "JavaScript", "HTML", "CSS", "Git", "GitHub", "CI/CD"],
    relatedProjectId: "techhub",
  },
  {
    org: "Revature",
